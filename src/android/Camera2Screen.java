...
public class Camera2Screen extends CameraScreen {
    ...
    public static Camera2Screen newInstance() {
        return new Camera2Screen();
    }
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable() && isInited) {
...
//        mButtonVideo.setText("Record");
    ...
    @Override
    boolean showSkeleton(boolean enable) {
        return false;
    }

    @Override
    boolean isSkeletonShowing() {
        return false;
    }

    @Override
    boolean showBoundingBox(boolean enable) {
        return false;
    }

    @Override
    boolean isBoundingBoxShowing() {
        return false;
    }

    @Override
    void startCapture(int nmsRadius, int outputStride, float scoreTreshold, float minConfidence) {
        // TODO: 07.06.19  implement this
    }
